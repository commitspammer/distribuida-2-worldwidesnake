...
var gameEvents = new EventSource("http://localhost:8080/game/events");
gameEvents.addEventListener("newState", function (e) {
...
function createBoard(height, width) {
  ...
  // Create bottom wall
  var bottomWall = "=".repeat(width + 2);
  board.push(bottomWall);
  return board;
}
scene("main", function () {
  var map = addLevel(createBoard(40, 40), {
    width: block_size,
    height: block_size,
    pos: vec2(0, 0),
    "=": function _() {
...
scene("teste", function () {
  var curSize = 48;
  var pad = 24;
  var nameText = add([text("Enter your name:", {
    width: width() - pad * 2,
    size: curSize,
    align: "center",
    lineSpacing: 8,
    letterSpacing: 1
  }), pos(width() / 2, height() / 2 - 50), origin("center")]);
  var input = add([pos(width() / 2, height() / 2), origin("center"), text([], {
    width: width() - pad * 2,
    size: curSize,
    align: "center",
    lineSpacing: 8,
  ...
  onKeyPressRepeat("enter", function () {
    postData(input.text).then(function (response) {
  ...
  onKeyPressRepeat("backspace", function () {
  ...
  function _postData() {
    _postData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name) {
      var response;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch(API_URL + "/game/snakes", {
              method: "POST",
              headers: {
...
go("teste");
},{"kaboom":"../node_modules/kaboom/dist/kaboom.mjs"}],"../../../../AppData/Roaming/nvm/v16.18.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../AppData/Roaming/nvm/v16.18.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","main.js"], null)
